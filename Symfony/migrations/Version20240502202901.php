 ...
 */
final class Version20240502202901 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT NOT NULL, product_id INT DEFAULT NULL, category_name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE favoris (id INT NOT NULL, users_id INT DEFAULT NULL, products_id INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, users_id INT DEFAULT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, color VARCHAR(50) NOT NULL, condition_product VARCHAR(50) NOT NULL, price DOUBLE PRECISION NOT NULL, imagefile VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
